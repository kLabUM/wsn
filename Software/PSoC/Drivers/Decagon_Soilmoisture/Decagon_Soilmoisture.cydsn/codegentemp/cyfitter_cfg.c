...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000544u)

/* UDB_0_4_0_CONFIG Address: CYDEV_UCFG_B0_P6_U1_BASE Size (bytes): 128 */
#define BS_UDB_0_4_0_CONFIG_VAL ((const uint8 CYFAR *)0x4800054Cu)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480005F8u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x09C3u);
